       ...
       <input type="text" class="form-control"   name= "phone" id="phone"  required  placeholder="هاتف الطالبة ">
                    ...
                    <!-- <input type="text" class="form-control"  name ="the_college" id="the_college"  required placeholder="الكلية  ">-->
                     <div class="select-editable col-sm-6">
                      ...
                      <option value="" selected>اختر كليتك</option>
                      <option value="Medicine" >كلية الطب</option>
                      <option value="أدخل اسم كليتك هنا..." >كلية أخرى</option>
                        
                      </select>
                <input type="text" name ="the_college" required palceholder="أدخل اسم كليتك هنا..."/>
                               ...
                               <div class="col parent_input" style="margin-left:10px;">
                             <div class="input-group mb-3" style="width:102%;">
